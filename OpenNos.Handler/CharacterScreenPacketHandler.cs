...
namespace OpenNos.Handler
{
    public class CharacterScreenPacketHandler : IPacketHandler
    {
        ...
        public void CreateCharacter(CharacterCreatePacket characterCreatePacket)
        {
            ...
            if (rg.Matches(characterName).Count == 1)
            {
                ...
                if (character == null || character.State == CharacterState.Inactive)
                {
                    ...
                    var insertResult = DAOFactory.CharacterDAO.InsertOrUpdate(ref newCharacter);
                    var sk1 = new CharacterSkillDTO { CharacterId = newCharacter.CharacterId, SkillVNum = 200 };
                    var sk2 = new CharacterSkillDTO { CharacterId = newCharacter.CharacterId, SkillVNum = 201 };
                    var sk3 = new CharacterSkillDTO { CharacterId = newCharacter.CharacterId, SkillVNum = 209 };
                    var qlst1 = new QuicklistEntryDTO
                    {
                    ...
                    var qlst2 = new QuicklistEntryDTO
                    {
                        CharacterId = newCharacter.CharacterId,
                        Q2 = 1,
                        Slot = 2
                    };
                    var qlst3 = new QuicklistEntryDTO
                    {
                        CharacterId = newCharacter.CharacterId,
                        Q2 = 8,
                        Type = 1,
                    ...
                    var qlst4 = new QuicklistEntryDTO
                    {
                        CharacterId = newCharacter.CharacterId,
                        Q2 = 9,
                        Type = 1,
        ...
        public void DeleteCharacter(CharacterDeletePacket characterDeletePacket)
        {
            ...
            {
                var character = DAOFactory.CharacterDAO.FirstOrDefault(s => s.AccountId == account.AccountId && s.Slot == characterDeletePacket.Slot && s.State == (byte)CharacterState.Active);
                if (character == null)
                {
                    return;
                }
            ...
            if (Session.Account == null)
            {
                ...
                if (loginPacketParts.Length > 4 && hasRegisteredAccountLogin)
                {
                    if (account != null)
                    {
                        ...
                        {
                            var penalty = DAOFactory.PenaltyLogDAO.FirstOrDefault(s => s.AccountId == account.AccountId && s.DateEnd > DateTime.Now && s.Penalty == PenaltyType.Banned);
                            if (penalty != null)
                            {
