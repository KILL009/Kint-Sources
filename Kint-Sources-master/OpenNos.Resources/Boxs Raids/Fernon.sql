...
VALUES
	(@BoxDesign, @BoxVNum, '17', '1', @EpeeFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @ArbaFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @ArmureFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @ArcFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @DagueFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @TuniqueFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @BatonFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @GunFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '17', '1', @RobeFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '100', '25', @PotionFULL, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '100', '20', @BlueStone, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '80', '8', @DragonSkin, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '80', '6', @DragonHeart, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '80', '8', @DragonBlood, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '1', '1', @CollierLaurena, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '1', '1', @AnneauLaurena, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '1', '1', @BraceletLaurena, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '80', '50', @AngelWings, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '80', '50', @FullMoon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '3', '1', @Aegir, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '3', '1', @Foxy, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '3', '1', @Hongbi, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '3', '1', @Cheongbi, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '3', '1', @Arlequin, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '5', '1', @Erdimine, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '1', '1', @FairyFireFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '1', '1', @FairyWaterFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '1', '1', @FairyLightFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '1', '1', @FairyDarkFernon, '0', '0', '0'),
	(@BoxDesign, @BoxVNum, '2', '1', @FernonBoots, '0', '0', '0');
