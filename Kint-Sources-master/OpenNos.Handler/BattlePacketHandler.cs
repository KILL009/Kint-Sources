...
namespace OpenNos.Handler
{
    ...
    {
        private IList<CharacterSkill> skills;
        ...
        public void MultiTargetListHit(MultiTargetListPacket mutliTargetListPacket)
        {
            ...
            if (mutliTargetListPacket.TargetsAmount > 0 && mutliTargetListPacket.TargetsAmount == mutliTargetListPacket.Targets.Count && mutliTargetListPacket.Targets != null)
            {
                ...
                foreach (MultiTargetListSubPacket subpacket in mutliTargetListPacket.Targets)
                {
                    ...
                    characterSkills?.FirstOrDefault(s => s.Skill.CastId == subpacket.TargetId - 1);
                    ...
                    {
                        Session.SendPacket($"sr {subpacket.TargetId - 1}");
                    });
                }
            ...
            void UseSkill(UseSkillPacket useSkillPacket)
            {                
            ...
            /// <param name="useAoeSkillPacket"></param>
             void UseZonesSkill(UseAOESkillPacket useAoeSkillPacket)
            {
                if (Session.Character.Invisible)
                {
                    Session.Character.Invisible = false;
             ...
             void PvpHit(HitRequest hitRequest, ClientSession target)
            {
             ...
             void TargetHit(int castingId, int targetId, bool isPvp = false)
            {
                if (Session.Character.Invisible)
                {
                    Session.Character.Invisible = false;
