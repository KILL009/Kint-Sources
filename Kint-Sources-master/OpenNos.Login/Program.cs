            ...
            checked
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        NetworkManager<LoginCryptography> networkManager = new NetworkManager<LoginCryptography>("173.249.28.51", port, typeof(LoginPacketHandler), typeof(LoginCryptography), false);
                    }
                    catch (Exception ex)
                    {
