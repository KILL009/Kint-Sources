...
namespace OpenNos.GameObject.Event
{
    public class LOD
    {
        ...
        public static void GenerateLod(int lodtime = 60)
        {
            ...
            const int HORN_REPAWN = 4;
            const int HORN_STAY = 1;
            ...
            Observable.Timer(TimeSpan.FromMinutes(0)).Subscribe(X => lodThread.Run(lodtime * 60, HORN_TIME * 60, HORN_REPAWN * 60, HORN_STAY * 60));
        }
