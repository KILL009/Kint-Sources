...
namespace OpenNos.GameObject.Helpers
{
    public class CellonGeneratorHelper : Singleton<CellonGeneratorHelper>
    {
        ...
        private static CellonGeneratorHelper instance;

        private readonly Dictionary<int, Dictionary<CellonType, CellonGenerator>> generatorDictionary =
            new Dictionary<int, Dictionary<CellonType, CellonGenerator>>
    {
        ...
        public new static CellonGeneratorHelper Instance => instance ?? (instance = new CellonGeneratorHelper());
        ...
        {
            Dictionary<CellonType, CellonGenerator> dictionary = generatorDictionary[itemEffectValue];
